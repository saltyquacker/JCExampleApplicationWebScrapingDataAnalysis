...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17251957302400312319)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17251958913881312320)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17251959961488312320)
,p_page_template_id=>wwv_flow_api.id(17251957302400312319)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17251960662839312320)
,p_page_template_id=>wwv_flow_api.id(17251957302400312319)
