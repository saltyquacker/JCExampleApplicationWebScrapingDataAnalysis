...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17252132931765312355)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252133467753312355)
,p_plug_template_id=>wwv_flow_api.id(17252132931765312355)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252133751536312355)
,p_plug_template_id=>wwv_flow_api.id(17252132931765312355)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252134171842312355)
,p_plug_template_id=>wwv_flow_api.id(17252132931765312355)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252134719305312355)
,p_plug_template_id=>wwv_flow_api.id(17252132931765312355)
,p_name=>'Sub Regions'
