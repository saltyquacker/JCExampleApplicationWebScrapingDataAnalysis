...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17252099424564312348)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252100027944312348)
,p_plug_template_id=>wwv_flow_api.id(17252099424564312348)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252100663815312348)
,p_plug_template_id=>wwv_flow_api.id(17252099424564312348)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252101275553312348)
,p_plug_template_id=>wwv_flow_api.id(17252099424564312348)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252101771951312348)
,p_plug_template_id=>wwv_flow_api.id(17252099424564312348)
,p_name=>'Sub Regions'
