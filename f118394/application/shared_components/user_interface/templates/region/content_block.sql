...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17252091133490312346)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252092033534312347)
,p_plug_template_id=>wwv_flow_api.id(17252091133490312346)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252092601706312347)
,p_plug_template_id=>wwv_flow_api.id(17252091133490312346)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252093276504312347)
,p_plug_template_id=>wwv_flow_api.id(17252091133490312346)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252093782104312347)
,p_plug_template_id=>wwv_flow_api.id(17252091133490312346)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252094249711312347)
,p_plug_template_id=>wwv_flow_api.id(17252091133490312346)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252094799016312347)
,p_plug_template_id=>wwv_flow_api.id(17252091133490312346)
,p_name=>'Sub Regions'
