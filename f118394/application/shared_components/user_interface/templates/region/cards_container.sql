...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17252050220672312338)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252050863522312338)
,p_plug_template_id=>wwv_flow_api.id(17252050220672312338)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252051330925312338)
,p_plug_template_id=>wwv_flow_api.id(17252050220672312338)
,p_name=>'Sub Regions'
