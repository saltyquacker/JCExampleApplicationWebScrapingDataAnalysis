...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17252158663470312361)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252159392408312361)
,p_plug_template_id=>wwv_flow_api.id(17252158663470312361)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252159983532312361)
,p_plug_template_id=>wwv_flow_api.id(17252158663470312361)
,p_name=>'Tabs'
