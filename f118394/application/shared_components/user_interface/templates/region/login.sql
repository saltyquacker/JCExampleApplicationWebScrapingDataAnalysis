...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17252136077699312355)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252136764476312355)
,p_plug_template_id=>wwv_flow_api.id(17252136077699312355)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252137167200312355)
,p_plug_template_id=>wwv_flow_api.id(17252136077699312355)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252137711262312356)
,p_plug_template_id=>wwv_flow_api.id(17252136077699312355)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252138110092312356)
,p_plug_template_id=>wwv_flow_api.id(17252136077699312355)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252138578432312356)
,p_plug_template_id=>wwv_flow_api.id(17252136077699312355)
,p_name=>'Sub Regions'
