...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17252173168163312364)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252173822780312364)
,p_plug_template_id=>wwv_flow_api.id(17252173168163312364)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252174343007312364)
,p_plug_template_id=>wwv_flow_api.id(17252173168163312364)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252174911879312364)
,p_plug_template_id=>wwv_flow_api.id(17252173168163312364)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252175506053312364)
,p_plug_template_id=>wwv_flow_api.id(17252173168163312364)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17252176142287312364)
,p_plug_template_id=>wwv_flow_api.id(17252173168163312364)
