...
@@application/shared_components/files/dried_cannabis_mb_jonny_chronic_tinashe_pre_roll_format_460170_700x_png.sql
@@application/shared_components/files/image2vector_svg.sql
@@application/shared_components/files/app_icon_min_css.sql
@@application/shared_components/files/pre_rolls_svg.sql
...
@@application/shared_components/user_interface/lovs/lov_gta.sql
